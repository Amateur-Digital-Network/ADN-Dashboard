...
<head>
    ...
    <?php
      if (file_exists('img/favicon.ico')) {
            ...
            echo '<link rel="icon" type="image/png" href="img/favicon_SAMPLE.ico">';
        }
      ?>
                                                    ...
                                                    <?php if (count($int_ids) !== 1): ?>
                                                        ...
                                                        <form method="post">
                                                            <select class="form-control form-control-sm" name="int_id" onchange="this.form.submit()">
                                                                ...
                                                                <option value="<?= htmlspecialchars($int_id) ?>" <?= (isset($_SESSION['selected_int_id']) && $_SESSION['selected_int_id'] === htmlspecialchars($int_id)) ? 'selected' : '' ?>><?= htmlspecialchars($int_id) ?></option>
                                                                <?php endforeach; ?>
                                                            </select>
                                                        </form>
                                                    <?php endif; ?>
