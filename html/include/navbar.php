...
<nav class="main-header navbar navbar-expand-lg navbar-light navbar-dark text-sm">
    <div class="container text-nowrap">
        <a href="#" class="navbar-brand">
            <img src="img/logo.png" alt="<?php echo $config['DASHBOARD']['NAVTITLE']; ?>" class="brand-image img-circle elevation-3"
                style="opacity: .8">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown dropdown-hover">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        <li><a href="index.php?p=calc" class="dropdown-item" id="nav_calc"></a></li>
                        <li><a href="index.php?p=wwtg" class="dropdown-item" id="nav_tglst"></a></li>
                        <li><a href="index.php?p=wwservers" class="dropdown-item" id="nav_srvlst"></a></li>
                    </ul>
                </li>
                <?php
